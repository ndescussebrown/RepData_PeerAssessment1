...
Median of the total number of steps taken per day = `r mediantotalsteps`.  
Mean of the total number of steps taken per day = `r meantotalsteps`
...
The time interval at which the max average number of steps is taken is `r maximum`.
...
```
The number of missing values in the dataset is `r missingval`.
...
Median of the total number of steps taken per day = `r mediantotalstepsfilled`.  
Mean of the total number of steps taken per day = `r meantotalstepsfilled`
